package com.tejeet.beets.ui.fragments.discover.search
...
class SearchAdapter(var dataItemList: MutableList<UsersData>):RecyclerView.Adapter<SearchAdapter.InboxViewHolder>() {
